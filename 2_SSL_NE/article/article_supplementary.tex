...
\begin{figure}[h!]
    \includegraphics[width=\textwidth]{./figures/haitz_law_old_both.pdf}
    \caption{Historical increase in flux for white light-emitting diode packages (\textit{"Haitz's Law"}), as it is often reproduced in literature. The original data by Haitz for red LEDs from 2000 is indicated for reference. Note the different range on the abscissa compared to \cref{fig:haitz}. Sources for red data: \cite{haitz1999case}\cite{haitz2011solid}. Sources for white-light data: figure \cref{fig:haitz}.}
    \label{fig:haitz-org}
\end{figure}
...
\begin{table}[h!]
    ...
    \CodeBefore
       \rectanglecolor{blue!10}{13-1}{14-10}
    \Body
    \hline
        \multirow{2}{*}{\textit{Year}} & \multirow{2}{*}{\textit{Tech.}} & \multirow{2}{*}{\textit{Purpose}} & \multirow{2}{*}{\textit{Period}} & \multirow{2}{*}{\textit{Base}} &  \multicolumn{4}{c|}{\textit{Parameters}} & \multirow{2}{*}{\textit{Source}} \\
    \cline{6-9}
         & & & & & \textit{M} & \textit{E} & \textit{G} & \textit{S} & \\
    \hline
        2018 & Solar & Cost reductions & 1980-2012 & steps & Y & N & Y & Y* & \cite{kavlak2018evaluating} \\
    \hline
        2013 & Solar & Geographic diff. in Cost & 2012 & Red. & Y & Y & Y & N & \cite{goodrich2013assessing} \\
    \hline
        2006 & Solar & Cost reductions & 1975-2001 & Red. & Y & N & Y & N & \cite{Nemetsolar} \\
    \hline
        2011 & IC & Cost reductions & 2011 & Steps & N & N & Y & Y & \cite{Gopalakrishnan2011} \\
    \hline
        2017 & Li-Ion & Technology comparison & 2017 & Steps & (Y) & (Y) & Y & Y & \cite{Ciez2017} \\
    \hline
        2015 & Li-Ion & Industry & 2015 & Steps & N & N & Y & Y &  \cite{Petri2015} \\
    \hline
        2012 & Li-Ion & Manufacturers & 2012-now & Steps & (Y) & N & Y & Y & \cite{Nelson2012} \\
    \hline
        2020 & Wind & Impact of breakthroughs & 2005-2017 & Steps & Y & Y & Y & Y & \cite{Elia2020} \\
    \hline
        2010 & Wind & Future cost savings & 2010 & Steps & N & N & Y & Y & \cite{Schubel2010} \\
    \hline
        2006 & Wind & Design changes & 1999-2006 & Ops. & N & N & Y & N & \cite{Fingersh2006} \\
    \hline
        2012 & LED & Cost reductions & 2012 & Steps & N & N & Y & Y & \cite{ledcomv2} \\
    \hline
        2020 & LED & Impact of breakthroughs & 2002-now & Steps & (Y) & (Y) & Y & Y & $^\text{this}_\text{work}$\\
    \hline
\end{NiceTabularX}
\vspace{3mm}
...
\cite{Scholand2012}\cite{casamayor2018comparative} some more text on model inputs
...
\textbf{Historical Progress in Sub-Efficiencies}
...
\clearpage
\textbf{Non-Phosphor-Related LED Innovations}
...
\begin{table}[h!]
\captionsetup{justification=raggedright,singlelinecheck=false}
    \caption{List of sources for \cref{fgr:subeff} grouped by LED sub-efficiencies.}
    \begin{NiceTabularX}{\textwidth}{|l|X|}
    \hline
