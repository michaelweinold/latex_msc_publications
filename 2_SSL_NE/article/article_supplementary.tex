...
% cross-referencing
\input{2_SSL_NE/article/auxiliary/preamble/1_preamble_functionality_crossreference}
...
\begin{table}[]
\small
    \caption{List of LED manufacturing cost model parameters considered in sensitivity analysis}
    \vspace{5mm}
...
\begin{table}[h!]
    ...
    \hline
    Panel A1 (FVE) & \cite{nichia2001data}\cite{lumi2003data}\cite{gen2005data}\cite{candlepwr2005data}\cite{lumi2006data}\cite{lumi2007data}\cite{nichia2008data}\cite{lumi2008data}\cite{osram2008data}\cite{jeong2011high}\cite{osram2012data}\cite{osram2013data}\cite{osram2014data} \newline \cite{lumi2016data_1}\cite{lumi2016data_2}\cite{epistar2017data}\cite{osram2017data_1}\cite{osram2017data_2}\cite{samsung2017data}\cite{samsung2018data}\cite{osram2018data}\cite{epistar2018data}\cite{lumi2019data} \\
    \hline
