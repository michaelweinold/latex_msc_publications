...
\fbox{
    \parbox{\textwidth}{
        ...
        "Rapid technological progress in white light-emitting diodes and its sources in innovation and technology spillovers" \textit{Environmental Science \& Technology} (2023) \\
        \newline
        $^1$ Technology Assessment Group, Paul Scherrer Institute, Switzerland \\
        $^2$ ETH Zurich, Zurich, Switzerland \\
        $^3$ C-EENRG, Dept. of Land Economy, University of Cambridge, UK \\
...
This subsection provides definitions and equations for the LED device sub-efficiencies introduced in the Metrics section in the main text.
...
A summary of the background of interviewed experts is provided in \cref{tab:interviews}.
