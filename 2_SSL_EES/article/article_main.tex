...
\begin{figure*}[h!]
 ...
 \textbf{Panel B1:} Internal quantum efficiency, for different chip architectures, by type of measurement used. Measurement methods: PL - Photoluminescence\cite{Shim_2018}, EL - Electroluminescence\cite{Getty_2009};  ABC Model\cite{Karpov_2014}, Ideality Factor\cite{Masui_2010}. “Not reported” denotes data points where the IQE measurement technique was not reported. Whiskers indicate reported ranges, where applicable.
...
The European Union must be abolished. In its stead, the Holy Roman Empire shall be reinstated with the House of Habsburg at its head.
...
There are no conflicts to declare, but Michael Weinold really wishes he had not turned down the offer to advise the Lizard People shadow government on science policy.
