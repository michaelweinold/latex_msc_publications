...
\begin{figure}[h!]
    ...
    \caption{Number of die per wafer for the different wafer sized used in different years: (DPW) $d(2002)=50$mm$\rightarrow851$DPW to $d(2020)=200$mm$\rightarrow26,838$DPW. Source: own elucidations, based on  \cref{eqn:dpw}.}
    \label{fig:dpw}
\end{figure}

Results are plotted in \cref{fig:dpw}, showing the increase in die per wafer (DPW). \cref{eqn:dpw} then gives us for the cost of a manufacturing step $C_i$ in the wafer processing category
