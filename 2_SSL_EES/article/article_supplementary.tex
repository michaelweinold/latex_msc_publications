...
\renewcommand{\tablename}{Table SI}
...
\begin{figure}[h!]
    ...
    \centering
    \caption{Schematic diagram of the cost model showing inputs to each step and computational steps leading to cost model outputs. For description of cost variables, see definitions for equation \cref{eqn:cost_wafer}.}
