...
\begin{table}[H]
    \begin{tabularx}{\textwidth}{ |l|X|X|l|l| }
        ...
        \hline
            \textit{Year} & \textit{Innovation} & \textit{Area of improvement} & \textit{Spillover} & \textit{Source} \\
        \hline
            1994 & DH & Higher radiative recombination \newline Probability & No & \cite{Nakamura1994} \\
        \hline
            1996 & multiple quantum well & Higher radiative recombination \newline Probability & No & \cite{Koike1996} \\
        \hline
